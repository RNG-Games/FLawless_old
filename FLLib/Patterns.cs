...
using FLLib.Pattern_Characteristics;
...
namespace FLLib
{
    ...
    public abstract class PolarPatterns : Patterns
    {
    ...
    public class SpiralPatterns : PolarPatterns
    {
    ...
    public class CirclePatterns : PolarPatterns
    {
